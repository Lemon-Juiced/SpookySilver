package dev.lemonjuice.spooky_silver.item.custom;
...
public class SilverSmithingTemplateItem extends SmithingTemplateItem {
    ...
    private static final ResourceLocation EMPTY_SLOT_BLOCK = SpookySilver.makeID("item/empty_slot_block");

    private static final Component APPLIES_TO = Component.translatable("tooltip.spooky_silver.applies_to").withStyle(DESCRIPTION_FORMAT);
    private static final Component INGREDIENTS = Component.translatable("tooltip.spooky_silver.ingredients").withStyle(DESCRIPTION_FORMAT);
    private static final Component UPGRADE_DESCRIPTION = Component.translatable("tooltip.spooky_silver.upgrade_description").withStyle(TITLE_FORMAT);
    private static final Component BASE_SLOT_DESCRIPTION = Component.translatable("tooltip.spooky_silver.base_slot_description");
    private static final Component ADDITIONS_SLOT_DESCRIPTION = Component.translatable("tooltip.spooky_silver.additions_slot_description");
