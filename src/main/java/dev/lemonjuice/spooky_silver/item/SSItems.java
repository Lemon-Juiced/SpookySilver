package dev.lemonjuice.spooky_silver.item;

import dev.lemonjuice.spooky_silver.SpookySilver;
import dev.lemonjuice.spooky_silver.item.custom.SSTiers;
import dev.lemonjuice.spooky_silver.item.custom.SilverSmithingTemplateItem;
import dev.lemonjuice.spooky_silver.item.custom.SilveredSwordItem;
...
public class SSItems {
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.createItems(SpookySilver.MODID);
